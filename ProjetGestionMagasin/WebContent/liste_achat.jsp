...
<c:forEach items="${liste_achat}" var="l">
<tr>
<td>${l.id}</td>
<td>${l.nom}</td>
<td>${l.prix}</td>
<td><a href=Servlet_achter?id=${l.id}&id_user=${id_user}&nom_user=${nom_user}> acheter </a></td>
</tr>
</c:forEach>
</table>
<form> <a href=Servlet_facture?id_user=${id_user}&nom_user=${nom_user}> Afficher panier et votre facture </a>
